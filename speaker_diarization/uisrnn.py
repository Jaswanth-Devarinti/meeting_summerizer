...
class UISRNN:
  ...
  def __init__(self, args):
    ...
    self.logger = diarization_utils.Logger(args.verbosity)
  ...
  def fit_concatenated(self, train_sequence, train_cluster_id, args):
    ...
    (sub_sequences,
     seq_lengths,
     transition_bias,
     transition_bias_denominator) = diarization_utils.resize_sequence(
    ...
    if args.batch_size is None:
      packed_train_sequence, rnn_truth = diarization_utils.pack_sequence(
          sub_sequences,
          seq_lengths,
          args.batch_size,
  ...
  def predict(self, test_sequences, args):
    ...
    if isinstance(test_sequences, list):
      return [self.predict_single(test_sequence, args) for test_sequence in test_sequences]
