...
def concatenate_training_data(train_sequences, train_cluster_ids,
  ...
  Args:
    ...
    enforce_uniqueness: a boolean indicated whether I should enfore uniqueness
...
def sample_permuted_segments(index_sequence, number_samples):
  ...
  Returns:
    sampled_index_sequences: 
      (a list of numpy arrays) - a list of subsampled
      block-preserving permuted sequences. For example,
      sampled_index_sequences = [[10,11,12,1,2,6],
                                [6,1,2,10,11,12],
                                [1,2,10,11,12,6],
                                [6,1,2,10,11,12],
                                [1,2,6,10,11,12]]
