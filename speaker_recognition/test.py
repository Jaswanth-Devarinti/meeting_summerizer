...
def main():
    ...
    if args.test_type == 'normal':
        verify_list = np.loadtxt('./datasets/voxceleb1/meta/voxceleb1_veri_test.txt', str)
    elif args.test_type == 'hard':
        verify_list = np.loadtxt('./datasets/voxceleb1/meta/voxceleb1_veri_test_hard.txt', str)
    elif args.test_type == 'extend':
        verify_list = np.loadtxt('./datasets/voxceleb1/meta/voxceleb1_veri_test_extended.txt', str)
    else:
