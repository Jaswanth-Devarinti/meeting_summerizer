...
def main():
    ...
    # Get Train/Val.
    trnlist, trnlb = toolkits.get_voxceleb2_datalist(args, path='./speaker_recognition/datasets/meta/voxlb2_train.txt')
    vallist, vallb = toolkits.get_voxceleb2_datalist(args, path='./speaker_recognition/datasets/meta/voxlb2_val.txt')
    ...
    if args.ohem_level > 1:     # online hard negative mining will be used
        ...
        A = ohem_generator.next()   # Warm up the generator
